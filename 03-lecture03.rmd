...
harmonic mean are called **special averages**. These measures reflect
...
**Example 3.2** Table below shows the plant height of 50 plants. Find
...
: (#tab:plantheight) Plant height of 50 plants.
...
| Plant height(*x*) |       Frequency(*f*)        | $$\mathbf{d}_{\mathbf{i}}\mathbf{=}\mathbf{x}_{\mathbf{i}}\mathbf{-}\mathbf{161}$$ | $\mathbf{f}_{\mathbf{i}}\mathbf{d}_{\mathbf{i}}$ |
|:----------------:|:----------------:|:----------------:|:----------------:|
|        159        |              3              |                                        -2                                        |                        -6                        |
|        160        |              9              |                                        -1                                        |                        -9                        |
|        161        |             23              |                                        0                                         |                        0                         |
...
**Example 3.3** Shows the distribution of the marks scored by 60
...
: (#tab:math) Distribution of the marks scored by 60 students
...
=======
12, 12, 15, 17, 20, 22, 22, 26, 26. Here, N (= 9) is odd, and so, median
>>>>>>> d548f399770035f7bb22948635d0f655d0551b09
=$\left( \frac{9 + 1}{2} \right)^{\text{th}}$= 5^th^ ordered observation
= 20.
...
**Example 3.5**: The following is a frequency table of the score
...
: (#tab:score) Score obtained in a mathematics quiz.
...
**Example 3.6**: The table is a frequency table of the marks obtained in
...
: (#tab:median) Distribution of marks obtained in a competition.
...
positions. To find out the 25^th^ position and 26^th^ position, we add
...
```{r mediancf, echo=FALSE,fig.cap='median from a cumulative frequency curve ',out.width="50%", fig.align='center'}
...
: (#tab:medianheight)Distribution of heights of 60 students
...
```{r mediancf1, echo=FALSE,fig.cap='Median from a cumulative frequency curve Example 3.7',out.width="60%", fig.align='center'}
...
referred to as *bimodal*, example $b$ above is bimodal. Distributions may have several modes, in which
...
: (#tab:Blood) Blood groups of 20 patients
...
=======
Where $L$ = lower limit of the modal class; $f_{m}$= the frequency of
the modal class; $f_{p}$= the frequency of
>>>>>>> d548f399770035f7bb22948635d0f655d0551b09
...
: (#tab:earhead)frequency distribution of weights of sorghum ear heads
...
=======
$mode = 100 + \left( \frac{45-38}{2\times45-38 - 35} \right)20 =$ 108.235
>>>>>>> d548f399770035f7bb22948635d0f655d0551b09
...
<<<<<<< HEAD
```{r cf1, echo=FALSE,fig.cap='Median from a cumulative frequency curve for Example 3.10',out.width="60%", fig.align='center'}
=======
```{r cf1, echo=FALSE,fig.cap='Finding mode from histogram',out.width="60%", fig.align='center'}
>>>>>>> d548f399770035f7bb22948635d0f655d0551b09
...
<center>**"If the statistics are boring, you've got the wrong
numbers":- Edward R. Tufte**</center>
:::
