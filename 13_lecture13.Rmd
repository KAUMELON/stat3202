...
$Z = \frac{0.12 - 0.1}{\sqrt{0.12 \times 0.88}}$

$= 0.0615$

Here in our case table value of Z is 1.645, as it is a right tailed test. The calculated value of Z is less than the table value. So, we conclude that, we don't have enough evidence to reject the null hypothesis. So, it can be stated that proportion of bad apples in the population is 0.1.
...
$\sqrt{\frac{n_{1}s_{1}^{2} + n_{2}s_{2}^{2}}{n_{1} + n_{2}}}$ where $n$~1~ and $n$~2~ are the sample sizes, $s$~1~ and $s$~2~ are the sample standard deviations.
...
>3. Two random samples were drawn from two populations and the following data were obtained. Test whether the population means are equal. $n$~1~ = 400, $n$~2~ = 400, $\overline{x}_{1}$ = 250, $\overline{x}_{2}$ = 220, $\overline{x}_{1}, $s$~1~ = 40, $s$~2~ = 55
