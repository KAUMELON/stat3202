...
$$\mathbf{Geometric\ mean,\ GM = Antilog}\left( \frac{\sum_{\mathbf{i = 1}}^{\mathbf{n}}{\mathbf{\log}\mathbf{x}_{\mathbf{i}}}}{\mathbf{n}} \right)$$
...
Geometric
mean=$\text{Antilog}\left( \frac{\sum_{i = 1}^{n}{\log x_{i}}}{n} \right) = Antilog\left( \frac{8.926}{5} \right) = Antilog(1.785) = 60.95$
...
}{\text{GM} = \ Antilog\left( \frac{65.787}{32} \right) = Antilog\left( 2.0558 \right) = 10^{2.0558} = 113.72}$$
