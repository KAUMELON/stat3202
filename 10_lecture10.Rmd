...
-   E($X$) = $\int_{- \infty}^{\infty}{x p(x)\ \text{dx }}$
...
Find the probability assuming Bernoulli distribution of a
...
The average number of homes sold by a Realty company is 2
...
3.  A company known on the past experience that 3% of the bulbs they produced are defective. Assuming Poisson distribution find the probability of getting the following in a sample of 100 bulbs:
...
```{r noraml2, echo=FALSE,fig.cap='Mean=Median=Mode in normal distribution',out.width="80%", fig.align='center'}
...
When you have normally distributed data, the standard deviation can be used to determine the proportion of the values that fall within a
